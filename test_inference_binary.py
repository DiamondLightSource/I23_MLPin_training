...
def run_inference():
    ...
    for category in categories:
        ...
        for image_name in os.listdir(category_dir):
            ...
            print(
                f"Image: {image_name}, Prediction: {prediction}, Predicted Label: {predicted_label}, Actual Label: {category}"
            )
            ...
            if predicted_label == category:
                ...
                print(
                    f"Misclassified: {image_name}, Predicted: {predicted_label}, Actual: {category}"
                )
            total_predictions += 1
